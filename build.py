...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.qnyp.tisvprogresshub.js')
	...
	f = os.path.join(cwd,'Classes','ComQnypTisvprogresshubModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.qnyp.tisvprogresshub.js']
